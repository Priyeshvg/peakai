...
export function PartnersPage() {
  ...
  return (
    <>
      {/* Hero Section */}
      <section className="bg-gradient-to-b from-orange-50 to-white py-20 relative overflow-hidden">
        <GridPattern
          width={60}
          height={60}
          x={-1}
          y={-1}
          className="fill-orange-100/35 stroke-orange-100/45"
          squares={[
            [4, 4],
            [6, 6],
            [8, 2],
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center">
            <div className="inline-flex items-center bg-orange-50/60 backdrop-blur-sm border border-orange-200/40 text-orange-700 px-6 py-3 rounded-full text-sm font-semibold mb-8 shadow-lg">
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">
              ...
              <span className="block text-orange-600">Grow Your Revenue Together</span>
            </h1>
            
            <p className="text-xl text-gray-600 mb-10 max-w-3xl mx-auto leading-relaxed">
              Join our partner program and offer the most accurate LinkedIn phone finder to your clients. Earn <span className="font-semibold text-orange-600">25% commission</span> with <span className="font-semibold text-blue-600">dedicated support</span> and <span className="font-semibold text-green-600">co-marketing opportunities</span>.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
              <a 
                href="mailto:partners@thepeakai.com?subject=Partnership Inquiry"
                className="bg-gradient-to-r from-orange-600 to-red-600 text-white px-10 py-5 rounded-xl hover:from-orange-700 hover:to-red-700 transition-all duration-200 flex items-center justify-center space-x-3 text-lg font-semibold shadow-xl hover:shadow-2xl transform hover:-translate-y-1"
              >
              ...
              <a 
                ...
                className="border-2 border-orange-600 text-orange-600 px-10 py-5 rounded-xl hover:bg-orange-50 transition-all duration-200 flex items-center justify-center space-x-3 text-lg font-semibold"
              >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto mb-12">
              <div className="flex flex-col items-center p-6 bg-white/30 backdrop-blur-lg rounded-2xl border border-white/30 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                ...
                <div className="text-sm text-gray-700 text-center font-medium">Commission Rate</div>
                <div className="text-xs text-gray-600 mt-1">First year</div>
              </div>
              <div className="flex flex-col items-center p-6 bg-white/30 backdrop-blur-lg rounded-2xl border border-white/30 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                <div className="text-3xl font-bold text-green-600 mb-2">91%</div>
                <div className="text-sm text-gray-700 text-center font-medium">Accuracy Rate</div>
                <div className="text-xs text-gray-600 mt-1">Industry leading</div>
              </div>
              <div className="flex flex-col items-center p-6 bg-white/30 backdrop-blur-lg rounded-2xl border border-white/30 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                <div className="text-3xl font-bold text-blue-600 mb-2">50+</div>
                <div className="text-sm text-gray-700 text-center font-medium">Active Partners</div>
                <div className="text-xs text-gray-600 mt-1">Growing fast</div>
              </div>
              <div className="flex flex-col items-center p-6 bg-white/30 backdrop-blur-lg rounded-2xl border border-white/30 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                <div className="text-3xl font-bold text-purple-600 mb-2">₹5L+</div>
                <div className="text-sm text-gray-700 text-center font-medium">Avg. Monthly Revenue</div>
                <div className="text-xs text-gray-600 mt-1">Per partner</div>
              </div>
            </div>
          </div>
        </div>
            ...
            {partnerTypes.map((type, index) => {
              ...
              return (
                <div key={index} className="bg-white/30 backdrop-blur-lg p-8 rounded-3xl border border-white/30 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-4 text-center">{type.title}</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center p-6 bg-white/30 backdrop-blur-lg rounded-3xl border border-white/30 shadow-xl hover:shadow-2xl transition-all duration-300">
              ...
              <p className="text-gray-600 text-sm">Submit your partnership application with company details</p>
            </div>
            <div className="text-center p-6 bg-white/30 backdrop-blur-lg rounded-3xl border border-white/30 shadow-xl hover:shadow-2xl transition-all duration-300">
              <div className="w-16 h-16 bg-orange-600 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-600 text-sm">Our team reviews your application within 48 hours</p>
            </div>
            <div className="text-center p-6 bg-white/30 backdrop-blur-lg rounded-3xl border border-white/30 shadow-xl hover:shadow-2xl transition-all duration-300">
              <div className="w-16 h-16 bg-orange-600 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-600 text-sm">Complete onboarding and receive training materials</p>
            </div>
            <div className="text-center p-6 bg-white/30 backdrop-blur-lg rounded-3xl border border-white/30 shadow-xl hover:shadow-2xl transition-all duration-300">
              <div className="w-16 h-16 bg-orange-600 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-600 text-sm">Start earning 25% commission on all referrals</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-orange-600 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a 
              href="mailto:partners@thepeakai.com?subject=Partnership Inquiry"
              className="bg-white text-orange-600 px-8 py-4 rounded-lg hover:bg-gray-50 transition-colors flex items-center justify-center space-x-2 text-lg font-semibold"
            >
            ...
            <a 
              ...
              className="border-2 border-white text-white px-8 py-4 rounded-lg hover:bg-orange-700 transition-colors flex items-center justify-center space-x-2 text-lg font-semibold"
            >
