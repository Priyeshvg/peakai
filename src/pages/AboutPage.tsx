        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center">
            <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">
              About PeakAI
              <span className="block text-purple-600">Built for Sales & Recruiting Success</span>
            </h1>
            ...
            <div className="bg-white/20 backdrop-blur-lg rounded-2xl border border-white/30 shadow-lg p-6 max-w-xl mx-auto mb-10">
              <p className="text-lg text-gray-700 font-medium">
                Powered by <span className="text-purple-600 font-bold">Wealides Fintech Private Limited</span>
              </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto mb-12">
              ...
              <div className="flex flex-col items-center p-6 bg-white/30 backdrop-blur-lg rounded-2xl border border-white/30 shadow-xl">
                ...
                <div className="text-sm text-gray-700 text-center font-medium">Average Lookup</div>
              </div>
              <div className="flex flex-col items-center p-6 bg-white/30 backdrop-blur-lg rounded-2xl border border-white/30 shadow-xl">
                <div className="text-3xl font-bold text-orange-600 mb-2">24/7</div>
                <div className="text-sm text-gray-700 text-center font-medium">Support</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-purple-600 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          ...
          <a 
            ...
            className="bg-white text-purple-600 px-8 py-4 rounded-lg hover:bg-gray-50 transition-colors inline-flex items-center space-x-2 text-lg font-semibold"
          >
