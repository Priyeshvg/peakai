            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="space-y-12">
                ...
                <div className="flex items-start space-x-6">
                  ...
                  <div>
                    ...
                    <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                      <h4 className="font-semibold text-red-800 mb-2">We do NOT collect:</h4>
                ...
                <div className="flex items-start space-x-6">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-gray-900 mb-4">2. Platform Acceptance</h2>
                ...
                <div className="flex items-start space-x-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 mb-4">We use the data to:</p>
