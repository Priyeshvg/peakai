            ...
            <div className="max-w-2xl mx-auto relative">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-4 bg-white/60 backdrop-blur-sm border border-gray-200/50 rounded-xl text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent shadow-lg"
                />
              </div>
            </div>
          </div>
                ...
                <div key={index} className="bg-white/40 backdrop-blur-lg rounded-3xl shadow-xl border border-white/30 p-8 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                  ...
                  <ul className="space-y-3">
                    {category.articles.map((article, articleIndex) => (
                      <li key={articleIndex}>
                        <button className="text-left text-gray-600 hover:text-blue-600 transition-colors w-full">
                          {article}
                        </button>
                      </li>
                    ))}
                  ...
                  <div className="mt-6 text-center">
                    <button className="text-blue-600 hover:text-blue-700 font-semibold flex items-center justify-center space-x-2 mx-auto">
                      <span>View all</span>
          ...
          <div className="space-y-6">
            {faqs.map((faq, index) => (
              <div key={index} className="bg-white/40 backdrop-blur-lg rounded-3xl shadow-xl border border-white/30 p-8">
                ...
                <p className="text-gray-700 text-lg leading-relaxed ml-9">
                  {faq.answer}
                </p>
              </div>
            ))}
