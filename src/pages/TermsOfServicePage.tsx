      ...
      <section className="bg-gradient-to-b from-gray-50 to-white py-20 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center mb-16">
            <div className="inline-flex items-center bg-green-50/60 backdrop-blur-sm border border-green-200/40 text-green-700 px-6 py-3 rounded-full text-sm font-semibold mb-8 shadow-lg">
              ...
              <div className="space-y-12">
                ...
                <div className="flex items-start space-x-6">
                  ...
                  <div>
                    ...
                    <div className="mb-4">
                      <h4 className="font-semibold text-gray-900 mb-2">You may use the Service to:</h4>
                ...
                <div className="flex items-start space-x-6">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-gray-900 mb-4">2. Account Authentication</h2>
                ...
                <div className="flex items-start space-x-6">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-gray-900 mb-4">3. Credit System & Payments</h2>
                ...
                <div className="flex items-start space-x-6">
                  ...
                  <div>
                    ...
                    <div className="space-y-3 text-gray-700">
                      ...
                      <p>For refund requests, contact: <a href="mailto:purvi@thepeakai.com" className="text-blue-600 hover:text-blue-700 font-semibold">purvi@thepeakai.com</a></p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-6">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-gray-900 mb-4">6. Third-Party Data Sources</h2>
                    <p className="text-gray-700">
                ...
                <div className="flex items-start space-x-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      ...
                      <a href="mailto:purvi@thepeakai.com" className="text-blue-600 hover:text-blue-700 font-semibold">
                        purvi@thepeakai.com
                      </a>.
                    </p>
                  </div>
