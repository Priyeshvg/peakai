...
export function DirectorPhonePage() {
  const features = [
    {
      icon: Crown,
      ...
      <section className="bg-gradient-to-b from-purple-50 to-white py-20 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center">
            <div className="inline-flex items-center bg-purple-50/60 backdrop-blur-sm border border-purple-200/40 text-purple-700 px-6 py-3 rounded-full text-sm font-semibold mb-8 shadow-lg">
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">
              ...
              <span className="block text-purple-600">Reach Decision Makers Directly</span>
            </h1>
            
            <p className="text-xl text-gray-600 mb-10 max-w-3xl mx-auto leading-relaxed">
              Access verified phone numbers of <span className="font-semibold text-purple-600">CEOs, CTOs, CFOs</span>, and other <span className="font-semibold text-blue-600">C-level executives</span>. Skip gatekeepers and reach decision makers who can actually approve your deals.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
              <a 
                href="https://studio.thepeakai.com/billing"
                className="bg-gradient-to-r from-purple-600 to-blue-600 text-white px-10 py-5 rounded-xl hover:from-purple-700 hover:to-blue-700 transition-all duration-200 flex items-center justify-center space-x-3 text-lg font-semibold shadow-xl hover:shadow-2xl transform hover:-translate-y-1"
              >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto mb-12">
              {benefits.map((benefit, index) => (
                <div key={index} className="flex flex-col items-center p-6 bg-white/30 backdrop-blur-lg rounded-2xl border border-white/30 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                  ...
                  <div className="text-sm text-gray-700 text-center font-medium">{benefit.label}</div>
                  <div className="text-xs text-gray-600 mt-1 text-center">{benefit.description}</div>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div className="text-center p-8 bg-white/30 backdrop-blur-lg rounded-3xl border border-white/30 shadow-xl hover:shadow-2xl transition-all duration-300">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Identify Target Directors</h3>
              <p className="text-gray-600 mb-4">Search for CEOs, CTOs, CFOs and other C-level executives on LinkedIn in your target companies.</p>
            ...
            <div className="text-center p-8 bg-white/30 backdrop-blur-lg rounded-3xl border border-white/30 shadow-xl hover:shadow-2xl transition-all duration-300">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Premium Verification</h3>
              <p className="text-gray-600 mb-4">Our advanced algorithms verify executive-level contacts with 95% accuracy through multiple data sources.</p>
              <div className="bg-white/60 backdrop-blur-sm p-4 rounded-lg shadow-sm">
            ...
            <div className="text-center p-8 bg-white/30 backdrop-blur-lg rounded-3xl border border-white/30 shadow-xl hover:shadow-2xl transition-all duration-300">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Direct Connection</h3>
              <p className="text-gray-600 mb-4">Get the verified phone number instantly and connect directly with decision makers.</p>
              <div className="bg-white/60 backdrop-blur-sm p-4 rounded-lg shadow-sm">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <div className="bg-white/40 backdrop-blur-lg p-12 rounded-3xl shadow-xl border-2 border-purple-500/50 relative">
            <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
              <span className="bg-purple-500 text-white px-6 py-2 rounded-full text-sm font-medium">Premium Directors</span>
            </div>
            <div className="text-center mb-8">
              <div className="flex items-center justify-center mb-4">
                <span className="text-6xl font-bold text-purple-600">₹50</span>
                <span className="text-gray-600 ml-3 text-xl">per director contact</span>
              </div>
              <p className="text-sm text-gray-600">Worth every rupee for decision makers</p>
            </div>
            <ul className="space-y-4 mb-8">
              <li className="flex items-center">
                <CheckCircle className="w-6 h-6 text-green-500 mr-4" />
                <span className="text-gray-700 text-lg">95% accuracy for C-level executives</span>
              </li>
              <li className="flex items-center">
                <CheckCircle className="w-6 h-6 text-green-500 mr-4" />
                <span className="text-gray-700 text-lg">Premium verification process</span>
              </li>
              <li className="flex items-center">
                <CheckCircle className="w-6 h-6 text-green-500 mr-4" />
                <span className="text-gray-700 text-lg">Direct access to decision makers</span>
              </li>
              <li className="flex items-center">
                <CheckCircle className="w-6 h-6 text-green-500 mr-4" />
                <span className="text-gray-700 text-lg">100 credits back guarantee</span>
              </li>
              <li className="flex items-center">
                <CheckCircle className="w-6 h-6 text-green-500 mr-4" />
            ...
            <a 
              ...
              className="w-full bg-gradient-to-r from-purple-600 to-blue-600 text-white py-4 rounded-xl hover:from-purple-700 hover:to-blue-700 transition-colors text-center block font-semibold text-lg shadow-lg hover:shadow-xl"
            >
      ...
      <section className="py-20 bg-purple-600 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a 
              href="https://studio.thepeakai.com/billing"
              className="bg-white text-purple-600 px-8 py-4 rounded-lg hover:bg-gray-50 transition-colors flex items-center justify-center space-x-2 text-lg font-semibold"
            >
            ...
            <a 
              ...
              className="border-2 border-white text-white px-8 py-4 rounded-lg hover:bg-purple-700 transition-colors flex items-center justify-center space-x-2 text-lg font-semibold"
            >
