        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center">
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">
              LeadsAI Bulk Export
              <span className="block text-purple-600">From Apollo, Lusha & Sales Navigator</span>
            </h1>
            
            <p className="text-xl text-gray-600 mb-10 max-w-3xl mx-auto leading-relaxed">
              Export thousands of leads from your favorite platforms with <span className="font-semibold text-purple-600">verified phone numbers</span> and <span className="font-semibold text-blue-600">complete contact data</span>. Transform prospect lists into actionable datasets instantly.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
              ...
              <a 
                ...
                className="border-2 border-purple-600 text-purple-600 px-10 py-5 rounded-xl hover:bg-purple-50 transition-all duration-200 flex items-center justify-center space-x-3 text-lg font-semibold"
              >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto mb-12">
              <div className="flex flex-col items-center p-6 bg-white/30 backdrop-blur-lg rounded-2xl border border-white/30 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                ...
                <div className="text-sm text-gray-700 text-center font-medium">Leads per Export</div>
                <div className="text-xs text-gray-600 mt-1">Maximum capacity</div>
              </div>
              <div className="flex flex-col items-center p-6 bg-white/30 backdrop-blur-lg rounded-2xl border border-white/30 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                <div className="text-3xl font-bold text-green-600 mb-2">91%</div>
                <div className="text-sm text-gray-700 text-center font-medium">Data Accuracy</div>
                <div className="text-xs text-gray-600 mt-1">Verified contacts</div>
              </div>
              <div className="flex flex-col items-center p-6 bg-white/30 backdrop-blur-lg rounded-2xl border border-white/30 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                <div className="text-3xl font-bold text-blue-600 mb-2">5min</div>
                <div className="text-sm text-gray-700 text-center font-medium">Processing Time</div>
                <div className="text-xs text-gray-600 mt-1">For 1,000 leads</div>
              </div>
              <div className="flex flex-col items-center p-6 bg-white/30 backdrop-blur-lg rounded-2xl border border-white/30 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                <div className="text-3xl font-bold text-orange-600 mb-2">15+</div>
                <div className="text-sm text-gray-700 text-center font-medium">Data Fields</div>
                <div className="text-xs text-gray-600 mt-1">Per contact</div>
              </div>
            </div>
          </div>
        </div>
              ...
              return (
                <div key={index} className="bg-white/30 backdrop-blur-lg p-8 rounded-3xl border border-white/30 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                  ...
                  <div className="border-t border-gray-200 pt-4">
                    <p className="text-sm text-gray-600 mb-2">Export Formats:</p>
                    <div className="flex flex-wrap gap-2">
                      {platform.formats.map((format, formatIndex) => (
                        <span key={formatIndex} className="bg-purple-100 text-purple-700 px-2 py-1 rounded text-xs font-medium">
                          {format}
                        </span>
                      ))}
                    </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {exportSpecs.map((spec, index) => (
              <div key={index} className="bg-white/40 backdrop-blur-lg p-8 rounded-3xl shadow-xl border border-white/30">
                <h3 className="text-xl font-bold text-gray-900 mb-6 text-center">{spec.title}</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="bg-white/30 backdrop-blur-lg p-8 rounded-3xl shadow-xl border border-white/30">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Data Accuracy</h3>
            ...
            <div className="bg-white/30 backdrop-blur-lg p-8 rounded-3xl shadow-xl border border-white/30">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Privacy & Compliance</h3>
              <ul className="space-y-3 text-gray-700">
                <li className="flex items-start">
