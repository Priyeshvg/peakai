    ...
    <>
          ...
          <div className="text-center">
            ...
            <div className="bg-white/20 backdrop-blur-lg rounded-2xl border border-white/30 shadow-lg p-6 max-w-xl mx-auto mb-10">
              <p className="text-lg text-gray-700 font-medium">
                <span className="text-blue-600 font-bold">Wealides Fintech Private Limited</span>
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            ...
            <div className="text-center p-8 bg-white/30 backdrop-blur-lg rounded-3xl border border-white/30 shadow-xl hover:shadow-2xl transition-all duration-300">
              ...
              <div className="space-y-2">
                <a 
                  ...
                  className="block text-blue-600 hover:text-blue-700 font-semibold text-lg"
                >
            ...
            <div className="text-center p-8 bg-white/30 backdrop-blur-lg rounded-3xl border border-white/30 shadow-xl hover:shadow-2xl transition-all duration-300">
              ...
              <div className="text-green-600 font-bold text-2xl">24 Hours</div>
            </div>
            ...
            <div className="text-center p-8 bg-white/30 backdrop-blur-lg rounded-3xl border border-white/30 shadow-xl hover:shadow-2xl transition-all duration-300 md:col-span-2 lg:col-span-1">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">Support Available</h3>
              <p className="text-gray-600 mb-4">Monday - Friday</p>
              <div className="text-purple-600 font-bold text-lg">9:00 AM - 6:00 PM IST</div>
            </div>
            ...
            <form className="space-y-8">
              ...
              <div>
                ...
                <textarea
                  ...
                  name="message"
                  rows={6}
                  className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 resize-vertical"
              ...
              <div className="text-center">
                <button
                  type="submit"
                  className="bg-blue-600 text-white px-8 py-4 rounded-xl hover:bg-blue-700 transition-colors inline-flex items-center space-x-3 text-lg font-semibold shadow-lg hover:shadow-xl"
                >
      ...
      <section className="py-12 bg-blue-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-blue-100 mb-2">Your trusted partner in sales intelligence solutions</p>
