        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center">
            <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">
              PeakAI Blog
              <span className="block text-blue-600">Sales & Recruiting Insights</span>
            </h1>
              ...
              >
                <div className="md:flex">
                  ...
                  <div className="md:w-1/2 p-12">
                    ...
                    <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4 leading-tight line-clamp-3 hover:line-clamp-none transition-all duration-300">
                      {post.title}
                    </h3>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center space-x-2 text-blue-600 hover:text-blue-700 font-semibold transition-colors">
                        <span>Read More</span>
            ...
            {filteredPosts.filter(post => !post.featured || selectedCategory !== "All Posts").map((post) => (
              ...
              >
                ...
                <div className="p-8">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-3 leading-tight line-clamp-2 hover:line-clamp-none transition-all duration-300">
                    {post.title}
                  </h3>
