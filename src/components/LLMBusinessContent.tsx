import { Enterprise } from '../lib/supabase'
...
export function LLMBusinessContent({ enterprise }: LLMBusinessContentProps) {
  ...
  return (
    <div className="mt-8 bg-gray-50 rounded-xl p-6">
      <h2 className="text-xl font-semibold text-gray-900 mb-4">Business Information Summary</h2>
      ...
      <div className="space-y-4 text-gray-700">
        ...
        <div className="bg-blue-50 rounded-lg p-4 mt-6">
          <h3 className="font-semibold text-blue-900 mb-2">MSME Benefits Available</h3>
        ...
        <div className="bg-green-50 rounded-lg p-4">
          <h3 className="font-semibold text-green-900 mb-2">Location Advantages</h3>
