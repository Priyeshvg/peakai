      ...
      <div className="p-8 border-b border-gray-200/50">
        <div className="flex items-center mb-4">
          ...
          <div>
            ...
            <p className="text-gray-600">Real results from companies using PeakAI</p>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <div className="flex items-center mb-6">
              ...
              <div>
                <h4 className="text-2xl font-bold text-gray-900">{activeCase.company}</h4>
            ...
            <div className="bg-blue-50 rounded-2xl p-6">
              ...
              <div className="flex items-center">
                ...
                <div>
                  <p className="font-semibold text-gray-900">{activeCase.testimonial.author}</p>
                  <p className="text-gray-600">{activeCase.testimonial.position}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-2xl p-6 mb-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="text-center">
                  <div className="text-2xl font-bold text-blue-600">{activeCase.metrics.contactsFound.toLocaleString()}</div>
                  <div className="text-sm text-gray-600">Contacts Found</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-green-600">{activeCase.metrics.conversionRate}</div>
                  <div className="text-sm text-gray-600">Conversion Rate</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-purple-600">{activeCase.metrics.teamSize}</div>
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div className="bg-white/50 rounded-xl p-4 text-center">
                ...
                <div className="text-lg font-bold text-gray-900">{activeCase.results.timesSaved}</div>
                <div className="text-sm text-gray-600">Time Saved</div>
              </div>
              
              <div className="bg-white/50 rounded-xl p-4 text-center">
                <TrendingUp className="w-8 h-8 text-green-500 mx-auto mb-2" />
                <div className="text-lg font-bold text-gray-900">{activeCase.results.costReduction}</div>
                <div className="text-sm text-gray-600">Cost Saved</div>
              </div>
              
              <div className="bg-white/50 rounded-xl p-4 text-center">
                <Phone className="w-8 h-8 text-purple-500 mx-auto mb-2" />
                <div className="text-lg font-bold text-gray-900">{activeCase.results.accuracyImprovement}</div>
                <div className="text-sm text-gray-600">Accuracy</div>
              </div>
              
              <div className="bg-white/50 rounded-xl p-4 text-center">
                <Users className="w-8 h-8 text-orange-500 mx-auto mb-2" />
                <div className="text-lg font-bold text-gray-900">{activeCase.results.additionalMetric}</div>
            ...
            <div className="bg-blue-600 rounded-2xl p-6 text-center">
              ...
              <a
                ...
                className="inline-flex items-center bg-white text-blue-600 px-6 py-3 rounded-xl hover:bg-gray-50 transition-all duration-200 font-semibold"
              >
