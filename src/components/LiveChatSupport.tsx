                    ...
                    <div>
                      ...
                      <div className={`text-xs text-gray-500 mt-1 flex items-center ${
                        ...
                        {message.sender === 'user' && message.status === 'sent' && (
                          <Check className="w-3 h-3 ml-1 text-blue-600" />
                        )}
                      </div>
                    </div>
                  </div>
            ...
            <div className="border-t border-gray-200 p-3">
              <div className="flex items-center space-x-2">
                <input
                  ...
                  className="flex-1 border border-gray-300 rounded-full px-4 py-2 text-sm focus:outline-none focus:border-blue-500 transition-colors"
                  disabled={isTyping}
                />
                <button
                  onClick={handleSendMessage}
                  disabled={!inputValue.trim() || isTyping}
                  className="bg-blue-600 text-white rounded-full p-2 hover:bg-blue-700 transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed"
