      ...
      <div className="bg-white/95 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/30 p-8 max-w-md w-full relative">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mb-4">
            Get your first <span className="font-bold text-green-600">100 contacts for just ₹11</span> each!
          </p>
          <div className="flex items-center justify-center space-x-1 mb-4">
            ...
            <span className="text-sm text-gray-600 ml-2">4.9/5 from 1,000+ users</span>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-4 rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all duration-200 font-semibold text-lg shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
          >
