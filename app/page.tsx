...
function TrustedLogos() {
  return (
    <div className="text-center mb-16">
      <p className="text-lg font-semibold text-brand-900 mb-6">Trusted by Sales Teams & Recruiters Worldwide</p>
        ...
        {testimonials.map((testimonial, index) => (
          ...
          >
            <article className="bg-white/30 backdrop-blur-lg p-8 rounded-3xl shadow-xl border border-white/20">
              <div className="flex items-center mb-4 justify-center" role="img" aria-label="5 star rating">
                {[...Array(5)].map((_, i) => (
                  <Star key={i} className="w-5 h-5 text-brand-400 fill-current" aria-hidden="true" />
                ))}
              </div>
